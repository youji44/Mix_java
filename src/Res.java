/**
 * Mix Tank Data resources class for PDF content
 */
public final class Res {
    ...
    public static final MixData[] MIX_INFO = {
            ...
            new MixData("1.0 PURPOSE", "<html>To ensure truck loading and unloading operations are completed safely and to eliminate the" +
                    "<br> potential for injuries where vehicle and people interaction occurs.", MIX_STRING, 621),
            ...
            new MixData("2.0 SCOPE", "<html>This procedure applies to all employees, truck operators and other personnel involved in the " +
                    ...
                    "<br>include containers, palletised cargo, bulk bags, casing and project cargo", MIX_STRING, 622),
            ...
            new MixData("2.1 Responsibilities", "<html>The employee is responsible to comply with this procedure and follow instructions from the" +
                    ...
                    "<br>correctly.", MIX_STRING, 623, 622),
            ...
            new MixData("2.2 Background", "<html>Trucks may be loaded and unloaded either manually, by cranes and/or forklifts. The use of crane " +
                    ...
                    "<br>per Forklift SOP.", MIX_STRING, 624, 622),
            ...
            new MixData("3.0 PRECAUTIONS & LIMITATIONS", "<html>Employees must not stand on truck trailers during placement or removal of loads by cranes " +
                    ...
                    + "<br>need to be controlled by another person while in use.", MIX_STRING, 625),

            new MixData("4.0 PREREQUISITE ACTIONS", "", MIX_STRING, 626),
            new MixData("4.1 Radiological Concerns", "None", MIX_STRING, 627, 626),
            new MixData("4.2 Employee Safety", "<html>All Employees and Port Users are required to wear the minimum PPE requirements. For " +
                    ...
                    + "<br>detailed information.", MIX_STRING, 628, 626),
            new MixData("4.3 Special Tools and Equipment, Parts, and Supplies", "None", MIX_STRING, 629, 626),
            new MixData("4.4 Approvals & Notifications", "<html> 4.4.1 OBTAIN   Shift Manager approval prior to the initiation of this SOP", MIX_CHECKBOX, 401, 626),
            new MixData("4.5 Preliminary Actions", "<html>4.5.1 REVIEW   safety video prior to initiation of this SOP", MIX_CHECKBOX, 402, 626),

            new MixData("4.6 Field Preparations", "<html>4.6.1 REQUEST Shift Manager to determine if Mix Tank manual valve lineup is required to be performed", MIX_CHECKBOX, 403, 626),

            new MixData("5.0 PERFORMANCE", "Mix Tank Unloading Operation", MIX_STRING, 630),

            new MixData("5.1 Preparation of Mix Tank for Unloading",
                    "",
                    MIX_TABLE_DATA, MIX_DATA, 631, 630),

            new MixData("5.2 Mix Tank Unloading", "",
                    MIX_SAMPLE_DATA, MIX_DATA, 632, 630),

            new MixData("5.3 Completion of Mix Tank Unloading", "",
                    MIX_UPLOADING_DATA, MIX_DATA, 633, 630),

            new MixData("6.0 REFERENCES", "", MIX_STRING, 634),
            new MixData("6.1 Performance References", "<html>1. SOP-0011, Forklift Operations<br/>"
                    ...
                    + "5. SOP-0055, Hazard and Incident Reporting Procedure</html>", MIX_STRING, 635, 634),
            new MixData("6.2 Source Requirements", "<html>1. OSHA 1910.178, Powered industrial trucks<br/>"
                    ...
                    + "3. OSHA 1910.147, Portable fire extinguishers</html>", MIX_STRING, 636, 634),

            new MixData("7.0 RECORDS", "<html>This completed procedure is to be retained and dispositioned as directed by company policy.", MIX_STRING, 637),

            new MixData("8.0 ATTACHMENTS", "None", MIX_STRING, 638),

            new MixData("11.0 MIX TANK LOW TEMPERATURE", "", MIX_LOW_DATA, MIX_DATA, 639, 0)
    };
}
